...
export const CORE_REPLY_PRINCIPLES: string[] = [
  ...
  "Lis la question réelle avant tout mot-clé. Jamais de réponse stock/lien si on n'a pas demandé si c'est dispo.",
  ...
  "Facture / TVA : NO_REPLY. Ne dis pas oui, ne promets rien — le vendeur l'envoie à la main.",
...
export const STYLE_BANS: string[] = [
  ...
  "« Je ne peux pas fournir d'informations… » / « je vous encourage à vérifier » / « source fiable » / « n'hésitez pas » / « détails ne sont pas disponibles »",
  ...
  "résumer l'annonce ou lister des specs non demandées",
];
